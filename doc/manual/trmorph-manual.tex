...
like 
\xmplt{Türkiye Büyük Millet Meclisi}{Grand National Assembly of Turkey}, \xmplt{Ağrı Dağı}{Mount Ararat} or 
...
plural readings. For example,
    ...
    (ev\mtag{N}\mtag{p3s}) as well as `their house' (ev\mtag{N}\mtag{p3p}).
    ...
    both singular (`he/she read-PAST' oku\mtag{V}\mtag{past}\mtag{3s}) 
    and plural (`he/she read-PAST' oku\mtag{V}\mtag{past}\mtag{3p}) 

...
demo can be accessed through \url{http://coltekin.net/cagri/trmorph}. 
...
The distribution also includes a converter that does a best-effort conversion from the tagset generated by \cite{oflazer1994}. 
It is a simple xfst script that takes \cite{oflazer1994} as surface,
...
The implementation here also follows \textcite{goksel2005}.
The machinery needed for g2p is in place and functional,
but marking exceptional cases in the lexicon is far from complete.
...
An example model trained on the data set used by \cite{yuret2006} (originated from \cite{hakkani-tur2002}) can be found at

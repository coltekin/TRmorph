...
\xmpl{\mroot{oku}\mtag{V}\mtag{part:fut}\mtag{Adj}\mtag{p1s}}
...
There are a few cases where the agreement marker can be attached somewhere else.
In a relatively common case, 
the agreement marker be on the question particle 
(see Section~\ref{ssec:question}), as in 
\mtag{2s} suffix \sffx{sIn} in 
\xmplt{uyuyacak- mı\textbf{sın}?}{are you going to sleep?} 
(dash `-' in the example marks the expected position of the suffix).
...
For example \xmplt{kahvaltı eder-, oltalarımızı alır-, balığa gider\textbf{iz}}{We have breakfast, take our hooks, an go fishing}.
...
The agreement marker can be made compulsory during the compile time.
